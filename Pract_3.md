...
## Решение:
```Jsonnet
local template_group(index) = "ИКБО-" + index + "-20";
local groups = [template_group(i) for i in std.range(1, 24)];
local template_student(age, group, name) = {
  'age': age,
  'group': group,
  'name': name,
};
...
local students = [
  template_student(19, "ИКБО-4-20", "Иванов И.И."),
  template_student(18, "ИКБО-5-20", "Петров П.П."),
  template_student(18, "ИКБО-5-20", "Сидоров С.С."),
  template_student(18, "ИКБО-65-23", "Ситнов М.В."),
];
...
let students : List Student =
    ...
    , { age = 18, group = "ИКБО-65-23", name = "Ситнов М.В." }
    ]
